...
public class SortingMeasurements {
	private static int differentSizes = 10; //how many sizes do you want to use in the measurements 
	private static int nTimes = 10000; //number of repetitions of the executions
